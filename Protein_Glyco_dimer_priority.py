...
dimer_report = {"number of proteins": int(number_of_protein),
                "number of monomers" : int(number_of_protein - len(unique_items_in_flattened_polymer_list)+duplicate_in_dimer_list), #the argument to this would be the differene of total number of proteins and proteins that have another protein neighbor which is a polyer gives the number of monomers with and without glycosylation
                "number of glycosylated monomers" : int(number_of_glycosylated_monomers),
                "number of non glycosylated monomers" : int(number_of_protein - len(unique_items_in_flattened_polymer_list)+duplicate_in_dimer_list -number_of_glycosylated_monomers),
                ...
                "number of non glycosylated dimer": len(dimer_list)-duplicate_in_dimer_list - len(index_removed_dimer_glycosylation)}
